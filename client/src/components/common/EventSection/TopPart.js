  ...
  return (
    <>
      <div className="container taras2">
        ...
        <div className="row">
          <div className="col-9 has-text-gray-bis fw-bold">Book a space, whatever  text, something about how happy you gonna be booking with us and how awesome everything will look after you spend hell of a lot of money. Basically a text, that is super important.</div>
